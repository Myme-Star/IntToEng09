...
public class IntToEngTest {
	...
	/*
	 * @Test public void testOnes() { String expected = "eight"; String actual =
	 * IntToEng.ones(8); assertThat(actual, equalTo(expected));
	 * 
	 * }
	 * 
	 * @Test public void testTens() { String expected = "eighty"; String actual
	 * = IntToEng.tens(8); assertThat(actual, equalTo(expected));
	 * 
	 * }
	 * 
	 * @Test public void testTeens() { String expected = "nineteen"; String
	 * actual = IntToEng.teens(19); assertThat(actual, equalTo(expected));
	 * 
	 * }
	 */
	@Test
	...
	public void test12118() {
		String expected = "twelve thousand one hundred eighteen";
		String actual = IntToEng.translateEng(12118);
		assertThat(actual, equalTo(expected));
	}

	@Test
	public void test120300() {
		String expected = "one hundred twenty thousand three hundred";
		String actual = IntToEng.translateEng(120300);
		assertThat(actual, equalTo(expected));
	}
	...
	public void test1000000() {
		...
		String actual = IntToEng.translateEng(1000000);
		assertThat(actual, equalTo(expected));
	}
}